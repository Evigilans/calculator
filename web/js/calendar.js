var _Calendar = function () {
    var _Calendar = {
        ...
        checkClick: function (e) {
            if (_Calendar.$('Calendar'))
                if (!_Calendar.isChild(_Calendar.evtTgt(e), _Calendar.$('Calendar')))
        ...
        lcs: function (t) { // может быть передано event или this
            ...
            if (t) {
                //console.log(t.dataset.yearfrom);
    ...
    s += "\n" + '<tr style="background:#eeaa33;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>';
    ...
    s += '<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#eeaa33" onclick="_Calendar.today()">Сегодня: ' + _Calendar.addnull(_Calendar.sccd, _Calendar.sccm + 1, _Calendar.sccy) + '</td></tr>';
    tbl.innerHTML = s;
